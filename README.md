...
**Статус:** v0.6.3 — MVP, live-verified на реальном аккаунте. 452 теста, билд чистый.
...
**v0.6.3** — Profile Views (видит уже приглашённых, листает до капа свежих, live-verified: 38 просмотров/прогон), Smart Connect (per-page, reliable STOP), Engagement (likes + короткие комментарии мнением/вопросом, по одному на пост, без само-вовлечения), Content pipeline v2 (ideas → approve → авто-публикация), live Dash-виджет, SSI-движок.
